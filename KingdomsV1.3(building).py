...
built10="Unbuilt"
built11="Unbuilt"
print("\n\nWelcome to Kingdoms, a kingdom role playing game where you upgrade, level up, and try to defeat your enemies.\n")
time.sleep(1)
print("Please select an opponent difficulty:")
print("1: Super Easy")
print("2: Easy")
print("3: Normal")
print("4: Hard")
print("5: Almost impossible to beat")
d=int(input())
if d==1:
    diffmult=2
elif d==2:
...
print("You start with 300 people in your kingdom. You start with 50 building materials, 50$, 300 food, and have 1 land. Your people produce 300 food/day, 1 building \nmaterial per day, and 1$ per day.\n\n")
print("They neighboring kingdom of "+name+" proposed a treaty! What do you do? If you accept, you will not be able to attack them, but you will be able to trade with \nthem.")
...
while endgame==False:
    ...
    buildingsLS=str(buildingsL)
    buildingsLS=buildingsLS.replace("[","")
    buildingsLS=buildingsLS.replace("]","")
    buildingsLS=buildingsLS.replace("'","")
    spellsS=str(spells)
    spellsS=spellsS.replace("[","")
    spellsS=spellsS.replace("]","")
    spellsS=spellsS.replace("'","")
    ...
    print("Spells: "+str(spellsS))
    print("Buildings: "+str(buildingsLS))
    print()
    ...
    if dailydecision=="a" or dailydecision=="A":
        if buildproupgradeprice>money:
            ...
            day=day+1
    elif dailydecision=="q" or dailydecision=="Q":
        print("Buildings you can build:")
        print("A: Stone Monolith (1 land, 60 building materials). Effects:\n   - +$5/day\n   ("+built1+")")
        print("B: Scarecrow (1 land, 60 building materials). Effects:\n   - +100 food/day\n   ("+built2+")")
        print("C: Baby Statue (1 land, 120 building materials). Effects:\n   - +2 population/day\n   ("+built3+")")
        print("D: Builder Statue (1 land, 200 building materials). Effects:\n   - +20 building materials/day\n   ("+built4+")")
        print("E: Sacrificial Altar (2 land, 350 building materials, 20 population). Effects:\n   - +2 deaths/day\n   - +1000 food/day\n   ("+built5+")")
        print("F: Embassy (4 land, 500 building materials, $300) (probably shouldn't build if your relationship score is 5). Effects:\n   - +2 relationship with "+name+" (maximum)\n   ("+built6+")")
        print("G: Bazaar (8 land, 700 building materials, $500). Effects:\n   - +$70/day\n   - +75 building materials/day\n   ("+built7+")")
        print("H: Temple (16 land, 1000 building materials, $1000). Effects:\n   - +50 population/day\n   - +$100/day\n   - +100 building materials/day\n   ("+built8+")")
        print("I: Business Tower (32 land, 3000 building materials). Effects:\n   - +500 building materials/day\n   ("+built9+")")
        print("J: Cash Tower (32 land, $3000). Effects:\n   - +$500/day\n   ("+built10+")")
        print("K: Life Monument (64 land, 5000 building materials, $5000). Effects:\n   - People no longer die (except people dying as sacrifices)\n   ("+built11+")")
            ...
            if built1=="Unbuilt":
                if land>=1:
                    if buildmaterials>=60:
                        ...
                        moneypro=moneypro+5
                        built1="Built"
                        print("Successfully built Stone Monolith!\n\n")
                        buildingsL.append("Stone Monolith")
                        time.sleep(1)
                        points=points+level*110
                        day=day+1
                    else:
                ...
                print("You already built this building!\n\n")
                day=day+1
        elif bdec=="b" or bdec=="B":
            if built2=="Unbuilt":
                if land>=1:
                    if buildmaterials>=60:
                        land=land-1
                        ...
                        foodpro=foodpro+100
                        built2="Built"
                        print("Successfully built Scarecrow!\n\n")
                        buildingsL.append("Scarecrow")
                        time.sleep(1)
                        points=points+level*110
                        day=day+1
                    else:
                ...
                print("You already built this building!\n\n")
                day=day+1
        elif bdec=="c" or bdec=="C":
            if built3=="Unbuilt":
                if land>=1:
                    if buildmaterials>=120:
                        land=land-1
                        buildmaterials=buildmaterials-120
                        popadd=popadd+2
                        built3="Built"
                        print("Successfully built Baby Statue!\n\n")
                        buildingsL.append("Baby Statue")
                        time.sleep(1)
                        points=points+level*130
                        day=day+1
                    else:
                        print("Not enough building materials!\n\n")
                        points=points-level*50
                ...
                print("You already built this building!\n\n")
                day=day+1
        elif bdec=="d" or bdec=="D":
            if built4=="Unbuilt":
                if land>=1:
                    if buildmaterials>=200:
                        land=land-1
                        buildmaterials=buildmaterials-200
                        buildmaterialspro=buildmaterialspro+20
                        built4="Built"
                        print("Successfully built Builder Statue!\n\n")
                        buildingsL.append("Builder Statue")
                        time.sleep(1)
                ...
                print("You already built this building!\n\n")
                day=day+1
        elif bdec=="e" or bdec=="E":
            if built5=="Unbuilt":
                if land>=2:
                    if buildmaterials>=350 and pop>=20:
                        land=land-2
                        buildmaterials=buildmaterials-350
                        pop=pop-20
                        foodpro=foodpro+1000
                        deathadd=deathadd+2
                        built4="Built"
                        print("Successfully built Sacrificial Altar, sacrificing 20 innocents in the process!\n\n")
                        buildingsL.append("Sacrificial Altar")
                        time.sleep(1)
                        points=points+level*160
                        day=day+1
                    else:
                        print("Not enough building materials/population!\n\n")
                        points=points-level*50
                        day=day+1
                else:
                    print("Not enough land!\n\n")
                ...
                print("You already built this building!\n\n")
                day=day+1
        elif bdec=="f" or bdec=="F":
            if built6=="Unbuilt":
                if land>=4:
                    if buildmaterials>=500 and money>=300:
                        land=land-4
                        buildmaterials=buildmaterials-500
                        money=money-300
                        if relationship<=3:
                        ...
                        built6="Built"
                        print("Successfully built Embassy!\n\n")
                        buildingsL.append("Embassy")
                        time.sleep(1)
                        points=points+level*180
                        day=day+1
                    else:
                        print("Not enough building materials/money!\n\n")
                        points=points-level*50
                        day=day+1
                else:
                    print("Not enough land!\n\n")
                ...
                print("You already built this building!\n\n")
                day=day+1
        elif bdec=="g" or bdec=="G":
            if built7=="Unbuilt":
                if land>=8:
                    if buildmaterials>=700 and money>=500:
                        land=land-8
                        buildmaterials=buildmaterials-700
                        money=money-500
                        moneypro=moneypro+70
                        buildmaterialspro=buildmaterialspro+75
                        built7="Built"
                        print("Successfully built Bazaar!\n\n")
                        buildingsL.append("Bazaar")
                        time.sleep(1)
                        points=points+level*190
                        day=day+1
                    else:
                        print("Not enough building materials/money!\n\n")
                        points=points-level*50
                ...
                print("You already built this building!\n\n")
                day=day+1
        elif bdec=="h" or bdec=="H":
            if built8=="Unbuilt":
                if land>=16:
                    if buildmaterials>=1000 and money>=1000:
                        land=land-16
                        buildmaterials=buildmaterials-1000
                        money=money-1000
                        moneypro=moneypro+100
                        buildmaterialspro=buildmaterialspro+100
                        popadd=popadd+50
                        built8="Built"
                        print("Successfully built Temple!\n\n")
                        buildingsL.append("Temple")
                        time.sleep(1)
                ...
                print("You already built this building!\n\n")
                day=day+1
        elif bdec=="i" or bdec=="I":
            if built9=="Unbuilt":
                if land>=32:
                    if buildmaterials>=3000:
                        land=land-32
                        buildmaterials=buildmaterials-3000
                        buildmaterialspro=buildmaterialspro+500
                        built9="Built"
                        print("Successfully built Business Tower!\n\n")
                        buildingsL.append("Business Tower")
                        time.sleep(1)
                        points=points+level*230
                        day=day+1
                    else:
                        print("Not enough building materials!\n\n")
                        points=points-level*50
                ...
                print("You already built this building!\n\n")
                day=day+1
        elif bdec=="j" or bdec=="J":
            if built10=="Unbuilt":
                if land>=32:
                    if money>=3000:
                        land=land-32
                        money=money-3000
                        moneypro=moneypro+500
                        built10="Built"
                        print("Successfully built Cash Tower!\n\n")
                        buildingsL.append("Cash Tower")
                        time.sleep(1)
                        points=points+level*230
                        day=day+1
                    else:
                ...
                print("You already built this building!\n\n")
                day=day+1
        elif bdec=="k" or bdec=="K":
            if built11=="Unbuilt":
                if land>=64:
                    if buildmaterials>=5000 and money>=5000:
                        land=land-64
                        buildmaterials=buildmaterials-5000
                        money=money-5000
                        deathcan=False
                        built11="Built"
                        print("Successfully built Life Monument! People no longer die, barring sacrifices.\n\n")
                        buildingsL.append("Life Monument")
                        time.sleep(1)
                        points=points+level*260
                        day=day+1
                    else:
                        print("Not enough building materials/money!\n\n")
                        points=points-level*50
